...
**The context.** I come across an internship posting (Takima, "AI Software & DevOps Engineer", the PopApp project around Green IT and Kubernetes). It asks for Java/Spring, React, Docker, Kubernetes and AI.

**The request.** I plug an AI into my MCP server and write: "Generate a CV tailored to this posting, from my base. Don't invent anything."
...
![CV generated for the Takima posting from the second brain](/blog/second-brain-cv-takima.png)

*The CV produced by the AI, purely from my notes, without me re-explaining anything.*

And the telling detail: during generation, the AI also **exposed the holes** in my base (missing email, phone, study years, RNCP frameworks). A CV doesn't just come out right: it shows what needed filling.
