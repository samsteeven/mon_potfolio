...
**Le contexte.** Je tombe sur une offre de stage (Takima, « AI Software & DevOps Engineer », projet PopApp autour du Green IT et de Kubernetes). Elle demande Java/Spring, React, Docker, Kubernetes et de l'IA.
...
![CV généré pour l'offre Takima à partir du second cerveau](/blog/second-brain-cv-takima.png)

*Le CV produit par l'IA, uniquement à partir de mes notes, sans que je réexplique quoi que ce soit.*

Et le détail qui compte : pendant la génération, l'IA a aussi **révélé les trous** de ma base (email, téléphone, années de formation, référentiels RNCP manquants). Un CV ne sort pas seulement juste : il montre ce qu'il fallait compléter.
