...
Le wizard configure le provider LLM (Anthropic Claude, OpenRouter, Nous Portal, ou tout endpoint compatible OpenAI) et prépare une première config fonctionnelle. À ce stade, tout tourne, mais en root, sans firewall, sans restriction d'outils. Le vrai travail commence là.
...
Après restriction, en ne gardant que ce qui est nécessaire pour un usage messagerie :
