...
L'outil d'automatisation autopilote peut lui-même mal tourner : une mauvaise isolation sur un VPS partagé, et c'est votre base de production qui paie les frais. Voici comment j'ai déployé n8n en production pour le projet [TribuneJustice](/fr/work/tribunejustice) — une plateforme legaltech que j'ai construite de A à Z et que je pilote — sans rien casser de l'infrastructure existante.
