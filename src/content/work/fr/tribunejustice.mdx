...
description: "Plateforme legaltech pour le marché camerounais, construite de bout en bout pour son fondateur expert juridique : API Laravel, frontend Angular SSR+PWA, blog Next.js, paiements séquestrés, consultations vidéo, messagerie temps réel, 41 vulnérabilités corrigées, LCP 5s à 1.5s."
date: "2026-06-14"
role: "Tech Lead"
