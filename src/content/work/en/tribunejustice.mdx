...
description: "Legaltech platform for the Cameroonian market, built end-to-end for its legal-expert founder: Laravel API, Angular SSR+PWA frontend, Next.js blog, escrow payments, video consultations, real-time messaging, 41 vulnerabilities closed, LCP 5s to 1.5s."
date: "2026-06-14"
role: "Tech Lead"
...
<CardGrid>
  ...
  <Card title="3x faster loading">
    LCP went from 5 seconds to under 1.5 seconds, images 94% lighter (68 MB to 3.9 MB), cache strategy rebuilt, budget halved.
  </Card>
