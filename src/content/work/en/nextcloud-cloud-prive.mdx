...
<CardGrid>
  ...
  <Card title="From specification to deployment">
    The Nextcloud/MariaDB/Redis/Nginx Docker stack was deployed and documented, the project doesn't stop at design.
  </Card>
</CardGrid>
...
And the complete loop, specification, architecture, real deployment, tutorial, oral defense, is the best way to verify that an architecture designed on paper runs in practice.