export const translations = {
  en: {
    ...
    about: {
      title: "About",
      q1: "Who I am",
      a1: "I am a Software Engineer and Security Researcher. I design robust web architectures, conduct deep security audits, and integrate autonomous AI agents into production environments.",
      q2: "My favorite stack",
      a2: "I build modern web systems with Next.js/React and TypeScript, backends with Node.js and Laravel, and automate workflows using AI agents (MCP, LangGraph, CrewAI).",
      q3: "Services I offer",
      a3: "I offer custom full-stack software development, security consulting (code audit, threat assessment), and advanced AI automation implementation.",
  ...
  fr: {
    ...
    about: {
      title: "À propos",
      q1: "Qui je suis",
      a1: "Je suis ingénieur logiciel et chercheur en sécurité. Je conçois des architectures web robustes, réalise des audits de sécurité approfondis et déploie des agents IA autonomes connectés à la production.",
      q2: "Ma stack préférée",
      a2: "Je bâtis des applications modernes avec Next.js/React et TypeScript, sécurise les backends avec Node.js et Laravel, et automatise les flux via des agents IA (MCP, LangGraph, CrewAI).",
      q3: "Services que j'offre",
      a3: "Je propose du développement logiciel full-stack sur mesure, du conseil en sécurité (audit de code, détection de failles) et l'intégration de workflows d'automatisation IA.",
      q4: "Comment démarrer",
